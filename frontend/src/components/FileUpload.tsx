                ...
                {isUploading ? (
                    ...
                    <>
                        <div className="mb-4 rounded-2xl border border-sky-200/80 bg-white p-4 text-sky-600 shadow-lg shadow-sky-500/10 transition-transform duration-300 group-hover:scale-105 dark:border-sky-500/30 dark:bg-slate-900 dark:text-sky-300">
                            <span className="material-icons-round" style={{ fontSize: "30px" }}>
                                upload_file
                            </span>
                        </div>
                        ...
                        <div className="mt-4 flex flex-wrap justify-center gap-2">
                            {["PDF", "DOCX", "PNG", "JPG"].map((type) => (
                                <span key={type} className="rounded-full border border-slate-300/80 bg-white px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-slate-600 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-300">
                                    {type}
                                </span>
                            ))}
                        </div>
